...
//---------Petición POST-------------------------
export async function subirPresentacion({nombre,descripcion,localizacion,categoria,instagram_url,tienda_url,facebook_url,comentarios_url,logo_url, activo,artesanoId}) {
  ...
  `INSERT INTO presentacion (nombre, descripcion, localizacion, categoria, instagram_url, tienda_url, facebook_url, comentarios_url, logo_url, activo, artesano_id)
   VALUES (?,?,?,?,?,?,?,?,?,?,?)`,
  [nombre, descripcion, localizacion, categoria, instagram_url, tienda_url, facebook_url, comentarios_url, logo_url, activo, artesanoId]
  );
  return result;  
}
...
export async function modificarPresentacion(id,{nombre,descripcion,localizacion,categoria,instagram_url,tienda_url,facebook_url,comentarios_url,logo_url, activo,artesanoId}) {
   const [result] = await pool.query(
    `UPDATE presentacion 
     SET nombre=?, descripcion=?, localizacion=?, categoria=?, instagram_url=?, tienda_url=?, facebook_url=?, comentarios_url=?, logo_url=?, activo=?
     WHERE id = ?`,
    [nombre, descripcion, localizacion, categoria, instagram_url, tienda_url, facebook_url, comentarios_url, logo_url, activo, id]
  );
